  ...
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/bilalnasar/drug-discovery-model/blob/main/Drug%20Discovery%20Data%20Cleansing%20\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "code",
      "metadata": {
        "id": "cJGExHQBfLh7",
        "outputId": "ed263c12-20b2-480e-f7ab-97522c70d641",
        "colab": {
      ...
      "outputs": [
        {
          ...
          "text": [
            ...
            "\u001b[?25l\r\u001b[K     |██████                          | 10 kB 19.1 MB/s eta 0:00:01\r\u001b[K     |███████████▉                    | 20 kB 25.6 MB/s eta 0:00:01\r\u001b[K     |█████████████████▊              | 30 kB 13.7 MB/s eta 0:00:01\r\u001b[K     |███████████████████████▋        | 40 kB 10.8 MB/s eta 0:00:01\r\u001b[K     |█████████████████████████████▌  | 51 kB 4.7 MB/s eta 0:00:01\r\u001b[K     |████████████████████████████████| 55 kB 1.5 MB/s \n",
    ...
    },
    {
      ...
      "metadata": {
        "id": "Vxtp79so4ZjF",
        "outputId": "9aee4f3b-6862-4dbb-e849-3263b506b7f7",
        "colab": {
          "base_uri": "https://localhost:8080/",
          "height": 414
        }
      ...
      "outputs": [
        {
          ...
          "data": {
            "text/html": [
              "\n",
              "  <div id=\"df-29cd7eb5-e812-45d1-a912-c2b87064ec30\">\n",
              ...
              "</table>\n",
              "</div>\n",
              "      <button class=\"colab-df-convert\" onclick=\"convertToInteractive('df-29cd7eb5-e812-45d1-a912-c2b87064ec30')\"\n",
              ...
              "      <script>\n",
              "        const buttonEl =\n",
              "          document.querySelector('#df-29cd7eb5-e812-45d1-a912-c2b87064ec30 button.colab-df-convert');\n",
              "        buttonEl.style.display =\n",
              "          google.colab.kernel.accessAllowed ? 'block' : 'none';\n",
              "\n",
              "        async function convertToInteractive(key) {\n",
              "          const element = document.querySelector('#df-29cd7eb5-e812-45d1-a912-c2b87064ec30');\n",
              "          const dataTable =\n",
    ...
    },
    {
      ...
      "metadata": {
        "id": "StrcHMVLha7u",
        "outputId": "f0befd71-ad97-47fe-cf2b-ba7c633e903d",
        "colab": {
          "base_uri": "https://localhost:8080/",
          "height": 35
        }
    ...
    },
    {
      ...
      "metadata": {
        "id": "s9iUAXFdSkoM",
        "outputId": "aa11f7e6-4a0a-4e02-9a8b-d078fd4b3887",
        "colab": {
          "base_uri": "https://localhost:8080/",
          "height": 311
        }
      ...
      "outputs": [
        {
          ...
          "data": {
            "text/html": [
              "\n",
              "  <div id=\"df-44219bf2-0fe3-4016-b62a-0d0dfe96fad8\">\n",
              "    <div class=\"colab-df-container\">\n",
              "      <div>\n",
              "<style scoped>\n",
              "    .dataframe tbody tr th:only-of-type {\n",
              ...
              "</table>\n",
              "</div>\n",
              "      <button class=\"colab-df-convert\" onclick=\"convertToInteractive('df-44219bf2-0fe3-4016-b62a-0d0dfe96fad8')\"\n",
              "              title=\"Convert this dataframe to an interactive table.\"\n",
              "              style=\"display:none;\">\n",
              "        \n",
              "  <svg xmlns=\"http://www.w3.org/2000/svg\" height=\"24px\"viewBox=\"0 0 24 24\"\n",
              ...
              "      <script>\n",
              "        const buttonEl =\n",
              "          document.querySelector('#df-44219bf2-0fe3-4016-b62a-0d0dfe96fad8 button.colab-df-convert');\n",
              "        buttonEl.style.display =\n",
              "          google.colab.kernel.accessAllowed ? 'block' : 'none';\n",
              "\n",
              "        async function convertToInteractive(key) {\n",
              "          const element = document.querySelector('#df-44219bf2-0fe3-4016-b62a-0d0dfe96fad8');\n",
              "          const dataTable =\n",
              "            await google.colab.kernel.invokeFunction('convertToInteractive',\n",
              "                                                     [key], {});\n",
              "          if (!dataTable) return;\n",
    ...
    },
    {
      ...
      "metadata": {
        "id": "oNtBv36dYhxy",
        "outputId": "5926b1e7-f228-4fbe-d5ee-cb1d0030e994",
        "colab": {
          "base_uri": "https://localhost:8080/"
        }
      },
    ...
    },
    {
      ...
      "metadata": {
        "id": "6RBX658q65A5",
        "outputId": "e8c2e043-4903-4f5f-896f-90c8852bcd7f",
        "colab": {
          "base_uri": "https://localhost:8080/"
        }
      },
    ...
    },
    {
      ...
      "metadata": {
        ...
        "outputId": "61482b7d-6c70-4049-92d1-58fe1d635056"
      },
      "source": [
    ...
    },
    {
      ...
      "metadata": {
        "id": "iRIr1QiEJtuw",
        "outputId": "b5a896f3-10df-4356-b60e-a4bf9c18e4b1",
        "colab": {
          "base_uri": "https://localhost:8080/"
        }
      },
      ...
      "outputs": [
        {
          ...
          "name": "stdout",
          "text": [
            "-rw------- 1 root root 70334 Jan  4 21:34 '/content/gdrive/My Drive/Colab Notebooks/data'\n"
          ]
        }
      ]
    },
    {
      ...
      "metadata": {
        "id": "FO3cZC5vnCht",
        "outputId": "f23430aa-0248-44db-86e5-acb83c22547a",
        "colab": {
          "base_uri": "https://localhost:8080/"
        }
      },
    ...
    },
    {
      ...
      "metadata": {
        "id": "jwEJjx5b5gAn",
        "outputId": "39bf86e4-8290-411b-b9c3-8822173170d0",
        "colab": {
          "base_uri": "https://localhost:8080/"
        }
      },
    ...
    },
    {
      ...
      "metadata": {
        "id": "hkVOdk6ZR396",
        "outputId": "c3073cfd-32b1-447b-f9f2-dd4e69f74f54",
        "colab": {
          "base_uri": "https://localhost:8080/",
          "height": 834
        }
      ...
      "outputs": [
        {
          ...
          "data": {
            "text/html": [
              "\n",
              "  <div id=\"df-e497f88a-2d1e-4bfe-b466-dc6d12447076\">\n",
              "    <div class=\"colab-df-container\">\n",
              "      <div>\n",
              "<style scoped>\n",
              "    .dataframe tbody tr th:only-of-type {\n",
              ...
              "</div>\n",
              "      <button class=\"colab-df-convert\" onclick=\"convertToInteractive('df-e497f88a-2d1e-4bfe-b466-dc6d12447076')\"\n",
              "              title=\"Convert this dataframe to an interactive table.\"\n",
              "              style=\"display:none;\">\n",
              "        \n",
              "  <svg xmlns=\"http://www.w3.org/2000/svg\" height=\"24px\"viewBox=\"0 0 24 24\"\n",
              ...
              "      <script>\n",
              "        const buttonEl =\n",
              "          document.querySelector('#df-e497f88a-2d1e-4bfe-b466-dc6d12447076 button.colab-df-convert');\n",
              "        buttonEl.style.display =\n",
              "          google.colab.kernel.accessAllowed ? 'block' : 'none';\n",
              "\n",
              "        async function convertToInteractive(key) {\n",
              "          const element = document.querySelector('#df-e497f88a-2d1e-4bfe-b466-dc6d12447076');\n",
              "          const dataTable =\n",
              "            await google.colab.kernel.invokeFunction('convertToInteractive',\n",
              "                                                     [key], {});\n",
              "          if (!dataTable) return;\n",
    ...
    },
    {
      ...
      "metadata": {
        "id": "Li64nUiZQ-y2",
        "outputId": "4b6cf73f-96cb-4a57-97f6-1eaf37853d48",
        "colab": {
          "base_uri": "https://localhost:8080/",
          "height": 423
        }
      ...
      "outputs": [
        {
          ...
          "data": {
            "text/html": [
              "\n",
              "  <div id=\"df-d6d62c63-82fe-4c43-9441-d81260a94092\">\n",
              "    <div class=\"colab-df-container\">\n",
              "      <div>\n",
              "<style scoped>\n",
              "    .dataframe tbody tr th:only-of-type {\n",
              ...
              "</div>\n",
              "      <button class=\"colab-df-convert\" onclick=\"convertToInteractive('df-d6d62c63-82fe-4c43-9441-d81260a94092')\"\n",
              "              title=\"Convert this dataframe to an interactive table.\"\n",
              "              style=\"display:none;\">\n",
              "        \n",
              "  <svg xmlns=\"http://www.w3.org/2000/svg\" height=\"24px\"viewBox=\"0 0 24 24\"\n",
              ...
              "      <script>\n",
              "        const buttonEl =\n",
              "          document.querySelector('#df-d6d62c63-82fe-4c43-9441-d81260a94092 button.colab-df-convert');\n",
              "        buttonEl.style.display =\n",
              "          google.colab.kernel.accessAllowed ? 'block' : 'none';\n",
              "\n",
              "        async function convertToInteractive(key) {\n",
              "          const element = document.querySelector('#df-d6d62c63-82fe-4c43-9441-d81260a94092');\n",
              "          const dataTable =\n",
              "            await google.colab.kernel.invokeFunction('convertToInteractive',\n",
              "                                                     [key], {});\n",
              "          if (!dataTable) return;\n",
    ...
    },
    {
      "cell_type": "code",
      "source": [
        "columns_titles = [\"molecule_chembl_id\",\"canonical_smiles\",\"standard_value\",\"bioactivity_class\"]\n",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "xjKm7PHQBzOD",
        "outputId": "0c626e79-bfbb-43ed-cb8f-d710df9cdb19"
      },
      "execution_count": null,
      "outputs": [
        {
          ...
          "data": {
            "text/html": [
              "\n",
              "  <div id=\"df-6f949f75-2589-47d5-a807-0dda215c5ec5\">\n",
              "    <div class=\"colab-df-container\">\n",
              "      <div>\n",
              "<style scoped>\n",
              "    .dataframe tbody tr th:only-of-type {\n",
              ...
              "</table>\n",
              "</div>\n",
              "      <button class=\"colab-df-convert\" onclick=\"convertToInteractive('df-6f949f75-2589-47d5-a807-0dda215c5ec5')\"\n",
              "              title=\"Convert this dataframe to an interactive table.\"\n",
              "              style=\"display:none;\">\n",
              "        \n",
              "  <svg xmlns=\"http://www.w3.org/2000/svg\" height=\"24px\"viewBox=\"0 0 24 24\"\n",
              ...
              "      <script>\n",
              "        const buttonEl =\n",
              "          document.querySelector('#df-6f949f75-2589-47d5-a807-0dda215c5ec5 button.colab-df-convert');\n",
              "        buttonEl.style.display =\n",
              "          google.colab.kernel.accessAllowed ? 'block' : 'none';\n",
              "\n",
              "        async function convertToInteractive(key) {\n",
              "          const element = document.querySelector('#df-6f949f75-2589-47d5-a807-0dda215c5ec5');\n",
              "          const dataTable =\n",
              "            await google.colab.kernel.invokeFunction('convertToInteractive',\n",
              "                                                     [key], {});\n",
              "          if (!dataTable) return;\n",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "7nEVYuDy-gpv",
        "outputId": "c17d33f5-b9ff-4072-99e9-ba1d6ed40de6"
      },
      "execution_count": null,
      "outputs": [
        {
        ...
        },
        {
          ...
          "data": {
            "application/javascript": [
              "download(\"download_924bbd69-dbcb-45a7-b771-1f242fb4fbc9\", \"bioactivity_preprocessed_data.csv\", 10578)"
            ],
            "text/plain": [
              "<IPython.core.display.Javascript object>"
            ]
    ...
    },
    {
      ...
      "metadata": {
        "id": "UuZf5-MEd-H5",
        "outputId": "aaa7b922-4da3-4e58-fc49-96c36352c8ae",
        "colab": {
          "base_uri": "https://localhost:8080/"
        }
      },
      ...
      "outputs": [
        {
          ...
          "text": [
            "total 92\n",
            "-rw-r--r-- 1 root root 70334 Jan  4 21:34 bioactivity_data.csv\n",
            "-rw-r--r-- 1 root root 10578 Jan  4 21:38 bioactivity_preprocessed_data.csv\n",
            "drwx------ 5 root root  4096 Jan  4 21:34 gdrive\n",
    ...
    },
    {
      ...
      "metadata": {
        "id": "7PU7yU9leLV5",
        "outputId": "66465766-ccff-4250-b4b2-cb450e0fd3bb",
        "colab": {
          "base_uri": "https://localhost:8080/"
        }
      },
